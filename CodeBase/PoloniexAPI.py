...
# PoloniexAPI.py  
#
# Originally sourced from Poloniex@https://pastebin.com/fbkheaRb
# Rewritten here to support Python3.6 and additional API features.
#
# Nick Burns
# April 2018
...
class poloniex:
    def __init__(self, APIKey, Secret):
        self.APIKey = APIKey
        self.Secret = Secret
        self.webhandle = urllib3.PoolManager()
